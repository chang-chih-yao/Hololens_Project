        ...
        for dirPath, dirNames, fileNames in os.walk(file_arr[arr]):
            ...
            if len(dirPath) == 13:
                ...
                if len(fileNames) != 0:
                    ...
                    '''
                    if dirPath.split('\\')[1] == '1' and my_index >= 187 and my_index <= :
                        f_test.write(s)
                    elif dirPath.split('\\')[1] == '2' and my_index >= 272:
                        f_test.write(s)
                    elif dirPath.split('\\')[1] == '3' and my_index >= 300:
                        f_test.write(s)
                    elif dirPath.split('\\')[1] == '4' and my_index >= 290:
                        f_test.write(s)
                    elif dirPath.split('\\')[1] == '5' and my_index >= 260:
                        f_test.write(s)
                    elif dirPath.split('\\')[1] == '6' and my_index >= 297:
                        f_test.write(s)
                    else:
                        f_train.write(s)
                    '''
